...
\ \ \ Agora que a estrutura do site é conhecida e a inspeção dos dados de interesse foi feita utilizando as ferramentas de desenvolvedor do Firefox, o exemplo em R será mais direto. Neste exemplo, utiliza-se o pacote [**rvest**](https://rvest.tidyverse.org/), [**dplyr**](https://dplyr.tidyverse.org/) para criar a tabela com as informações coletadas, e [**purrr**](https://purrr.tidyverse.org/), que é um pacote de **R** voltado para programação funcional. O código utilizado para a extração pode ser visualizado abaixo:
