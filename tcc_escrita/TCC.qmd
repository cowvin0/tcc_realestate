...
Em Python, a biblioteca scikit-learn disponibiliza a classe sklearn.inspection.PartialDependenceDisplay para a criação de gráficos de ICE (Individual Conditional Expectation) e a inclusão opcional da linha de PDP (Partial Dependence Plot). Para gerar o gráfico, é necessário ter um modelo previamente ajustado. O código a seguir demonstra sua utilização:
