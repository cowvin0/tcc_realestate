...
average_values = df_inteiro.groupby("Bairro")["Área"].mean().reset_index(name='Área')
...
![Variação do valor médio dos imóveis](includes/map_valor_normal.png){#fig-mapa_valor fig-align="center"}

![Variação da média da área dos imóveis](includes/map_area_normal.png){#fig-mapa_area fig-align="center"}
