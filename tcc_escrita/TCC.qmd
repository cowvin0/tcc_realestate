...
\ \ \ Python [@van1995python] é uma linguagem de programação criada por Guido Van Rossum. Ela é uma linguagem de propósito geral e de fácil aprendizagem e entendimento devido a sua simples sintaxe.

\vspace{12pt}

Neste trabalho, o seu principal uso foi para realizar a modelagem e também para coleta de dados de site de imóveis. Para a realização da modelagem, foi utilizada a biblioteca scikit-learn [@scikit-learn], que comporta diversas ferramentas estatísticas e técnicas utilizadas em aprendizagem de máquinas. Os modelos utilizados tinham a necessidade de encontrar seus hiperparâmetros e, para encontrar esses hiperparâmetros, foi utilizado a biblioteca optuna, que comporta diversos métodos de otimização, até mesmo alguns métodos mais recentes de otimização bayesiana. Para a coleta de dados de imóveis, foi utilizado a biblioteca Scrapy @kouzis2016learning, que é um framework open-source em Python usado para realizar web scraping, ou seja, extrair dados de páginas da web de maneira automatizada. Ele permite que os usuários criem "crawlers" ou "spiders" para navegar em sites, coletando e estruturando informações específicas de maneira eficiente.

\vspace{12pt}

Além disso, o Python também foi utilizado para a criação de todos os gráficos e para manipulação de base de dados. A biblioteca para visualização de dados utilizada foi o Matplotlib [@Hunter:2007] e para a manipulação e organização das bases de dados foi utilizado a biblioteca pandas [@mckinney-proc-scipy-2010; @reback2020pandas], que é a biblioteca de Python mais utilizadas para manipulação de dados de séries temporais, análise de dados e estatísticas.
