...
Analisando a relação entre o hiperparâmetro de profundidade e o de número de folhas variando pela estatística de erro na @fig-lgbm_contour, observa-se que números maiores de folhas e uma profundidade menor na árvore apresenta um modelo com um menor erro. É possível também observar esse mesmo comportamento para os outros hiperparâmetros. Uma maior quantidade de folhas e uma taxa de aprendizado crescente apresentam também um modelo com menor erro, assim como uma maior quantidade de árvores também apresentam um modelo com menor erro.
