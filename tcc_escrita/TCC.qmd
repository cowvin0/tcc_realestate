...
\ \ \ Para a aplicação das ferramentas de modelagem, foram utilizadas as bibliotecas **scikit-learn**, **lightgbm** e **xgboost**. As duas últimas foram usadas especificamente para a modelagem, enquanto a primeira também foi utilizada para criar pipelines de pré-processamento de dados. Essas pipelines funcionam como etapas sequenciais de pré-processamento necessárias para os dados. Assim, os quatro modelos aplicados na previsão do valor do imóvel foram: Random Forest, Gradient Boosting, Light Gradient Boosting e XGBoost.
