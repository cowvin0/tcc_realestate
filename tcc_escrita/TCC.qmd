...
toc: true
title: Uso de Aprendizagem de Máquina na Modelagem Preditiva de Valores de Imóveis da Cidade de João Pessoa
...
Nesta etapa, também foi analisada a correlação entre as variáveis dependentes utilizadas no modelo, o que possibilitou a criação de novas variáveis com base na interação entre aquelas que apresentavam alguma relação. Para isso, utilizou-se a correlação de Spearman [@spearman1961proof].
