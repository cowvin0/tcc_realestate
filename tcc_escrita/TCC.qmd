...
$$
em que $c_1$ e $c_2$ é a média da variável dependente para as observações de treinamento nas regiões $R_1\left(j, s\right)$ e $R_2\left(j, s\right)$, respectivamente.

\vspace{12pt}

-- NO FIM ADICIONAR O ALGORITMO DO ISLP, PG 337 --
