...
- Criar visualizações que facilitem a interpretação dos resultados e apoiem a tomada de decisões no mercado imobiliário.
...
![](includes/rf_plot_predict2.svg){#fig-preds_rf}

![](includes/gdt_plot_predict2.svg){#fig-preds_gdt}
...
![](includes/lgbm_plot_predict2.svg){#fig-preds_lgbm}

![](includes/xgb_plot_predict2.svg){#fig-preds_xgb}
...
![](includes/stacking_plot_predict2.svg){height=200, width=400}
