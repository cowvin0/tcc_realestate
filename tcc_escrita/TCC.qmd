...
![Distribuição das variáveis numéricas](includes/violin_plots.svg){#fig-violin width=500 height=300}
...
for ax in axes:
    ...
    ax.set_ylabel('Densidade', fontsize=7.5)
    ax.set_xlabel('Valor', fontsize=7.5)
...
<!-- ![Comparação entre distribuição dos valores dos imóveis antes e depois da transformação logarítmica.](includes/density_plot_log.svg){#fig-densitarg width=500 height=300} -->
