...
$$
em que $\boldsymbol{\theta}_U = \left<\theta_{u_{1}}, \dots, \theta_{u_{m}}\right> \text{, com } \theta_{u_i} \in \Theta_{u_i}$, é o vetor correspondente a uma configuração parcial dos hiperparâmetros para o subconjunto $U = \{u_{1}, \dots, u_{m}\} \subseteq N$, que representa um subconjunto dos índices dos hiperparâmetros. Além disso, as componentes de $\hat{f}_{U} \left(\boldsymbol{\theta}_{U}\right)$ são definidas da seguinte forma:
