...
#              "2001", "2002", "2003", "2004", "Set 2005"],
#     "Números de Contratos Ativos": ["1.291.685", "1.279.198", "1.138.973", "1.027.322", "910.877",
#                                     "816.648", "596.397", "451.461", "410.335", "384.348", "371.614", "359.073"],
#     "Geral": ["8,80%", "10,90%", "14,10%", "14,60%", "14,70%", "19,30%",
              # "23,70%", "27,60%", "28,10%", "29,80%", "29,90%", "29,40%"],
#     "Até 1998": ["8,70%", "10,80%", "14,00%", "14,30%", "14,40%", "20,00%",
#                   "26,00%", "32,30%", "34,10%", "37,80%", "41,30%", "42,90%"],
#     "Pós 1998": ["-", "-", "-", "-", "1,70%", "9,20%", "12,00%", "11,10%",
#                  "10,50%", "11,20%", "9,70%", "9,00%"],
#     "Carteira Hipotecária": ["12,10%", "15,10%", "19,00%", "21,00%", "23,70%",
#                              "23,80%", "24,60%", "28,10%", "30,00%", "29,60%",
#                              "25,40%", "29,40%"]
# }
...
#     ("", "", "Anos"),
#     ("", "", "Números de Contratos Ativos"),
#     ("% mais de 3 prestações em atraso", "", "Geral"),
#     ("% mais de 3 prestações em atraso", "Assinados", "Até 1998"),
#     ("% mais de 3 prestações em atraso", "Assinados", "Pós 1998"),
#     ("% mais de 3 prestações em atraso", "", "Carteira Hipotecária")
# ])
# df.columns = columns

# teste = df.style.set_table_styles([
...
#     )\
#     .hide()
# df.style.set_table_styles([dict(selector='th', props=[('text-align', 'center')])]).set_properties(**{'text-align': 'center'}).hide()
```
