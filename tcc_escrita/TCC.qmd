...
dados = {
    "Anos": ["1994", "1995", "1996", "1997", "1998", "1999", "2000", "2001", "2002", "2003", "2004", "Set 2005"],
    "Números de Contratos Ativos": [1291685, 1279198, 1138973, 1027322, 910877, 816648, 596397, 451461, 410335, 384348, 371614, 359073],
    "Atraso Geral": ["8,80%", "10,90%", "14,10%", "14,60%", "14,70%", "19,30%", "23,70%", "27,60%", "28,10%", "29,80%", "29,90%", "29,40%"],
    "Atraso Assinados Até 1998": ["8,70%", "10,80%", "14,00%", "14,30%", "14,40%", "20,00%", "26,00%", "32,30%", "34,10%", "37,80%", "41,30%", "42,90%"],
    "Atraso Pós 1998": ["-", "-", "-", "-", "1,70%", "9,20%", "12,00%", "11,10%", "10,50%", "11,20%", "9,70%", "9,00%"],
    "Carteira Hipotecária": ["12,10%", "15,10%", "19,00%", "21,00%", "23,70%", "23,80%", "24,60%", "28,10%", "30,00%", "29,60%", "25,40%", "29,40%"]
}

df_inad = pd.DataFrame(dados)

df_inad.columns = pd.MultiIndex.from_tuples([
    ("Anos", ""),
    ("Números de Contratos Ativos", ""),
    ("% mais de 3 prestações", "Geral"),
    ("% mais de 3 prestações", "Assinados Até 1998"),
    ("% mais de 3 prestações", "Pós 1998"),
    ("Carteira Hipotecária", "")
])
df_inad.style.set_table_styles([dict(selector='th', props=[('text-align', 'center')])])\
        .hide(axis='index')
```
