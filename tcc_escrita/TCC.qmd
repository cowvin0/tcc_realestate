...
Na próxima sessão, apresenta-se um exemplo de como realizar web scraping em **R** e **Python**. Para isso, são utilizados alguns dos pacotes mencionados para a linguagem **R** e, no caso de **Python**, dá-se preferência ao [**Scrapy**](https://docs.scrapy.org/en/latest), a principal biblioteca empregada para a extração dos dados. Além disso, esta sessão também abordará a estruturar de um HTML e o funcionamento dos seletores para a extração de elementos.
...
**(FALAR SOBRE O YEOJOHNSON NA VARIÁVEL COM INTERAÇÃO ENTRE AS COORDENADAS)**
