...
\State \hspace{1em} \textbf{2.} Para $b = 1, 2, \dots, B$, repita:

\vspace{0.8em}

  \State \hspace{2em} (a) Ajuste uma árvore $\hat{f}^b$ com $d$ divisões $\left(d + 1 \text{ folhas}\right)$ para os dados de
