...
## Tunagem de hiperparâmetros com otimização bayesiana

\

Na aprendizagem de máquina, uma das principais etapas é a tunagem do hiperparâmetros, que se consiste em encontrar a melhor combinação de hiperparâmetros de um modelo. A tunagem desses hiperparâmetros torna a maioria dos algoritmos de aprendizagem de máquina configuráveis, permitindo encontrar modeloos com resultados que conseguem melhores generalizações. No entanto, essa configuração vem de forma não trivial.
