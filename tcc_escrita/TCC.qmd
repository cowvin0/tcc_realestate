...
Vale ressaltar que algumas bibliotecas externas, baseadas na API do [scikit-learn](https://scikit-learn.org/stable/), também foram utilizadas neste trabalho. Entre elas, destacam-se a [LightGBM](https://lightgbm.readthedocs.io/en/stable/) [@ke2017lightgbm] e a [XGBoost](https://xgboost.readthedocs.io/en/stable/) [@chen2016xgboost] [@chen2016xgboost], empregadas para a implementação de algoritmos de aprendizado de máquina. Essas bibliotecas fornecem, respectivamente, os algoritmos de gradient boosting LightGBM e Extreme Gradient Boosting, reconhecidos por sua eficiência computacional e desempenho em tarefas de modelagem preditiva.
