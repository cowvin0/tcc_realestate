...
toc: true
title: |
  O Mercado Imobiliário de João Pessoa: aplicação de técnicas estatísticas e algoritmos de aprendizado de máquina para a predição e análise de valores imobiliários
#   Análise e Modelagem de Valores de Imóveis no Município de João Pessoa: Uma Abordagem com Aprendizado de Máquina
