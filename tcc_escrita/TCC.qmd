...
<!-- Matematicamente, o fANOVA decompõe uma função $\hat y: \Theta_{1} \times \dots \times \Theta_{n} \rightarrow \mathbb{R}$ em componentes aditivos que dependem apenas de subconjuntos de suas instâncias $N$ que representa o conjunto $\{1,\dots,n\}$ de todos os hiperparâmetros de um algoritmo $A$. Assim, define-se: -->
