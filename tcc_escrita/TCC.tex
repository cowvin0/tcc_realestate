...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, colback={codebgcolor}, boxrule=0pt, frame hidden, enhanced, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
\hypersetup{
  pdftitle={Uso de Aprendizagem de Máquina na Modelagem Preditiva de Valores de Imóveis da Cidade de João Pessoa},
...
de Imóveis da Cidade de João Pessoa}
...
de Valores de Imóveis da Cidade de João Pessoa \par}
...
impactos das variáveis na predição dos valores dos imóveis. Além disso,
