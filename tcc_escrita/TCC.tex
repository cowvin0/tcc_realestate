...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, sharp corners, breakable, colback={codebgcolor}, enhanced, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
