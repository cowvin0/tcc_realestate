...
garantindo a consistência e eficiência do processamento dos dados.
Segue, então, a descrição das ferramentas empregadas na construção da
aplicação final.
...
\section{Recursos utilizados de forma complementar à
programação}\label{recursos-utilizados-de-forma-complementar-uxe0-programauxe7uxe3o}

\section{Recurso utilizado para a criação do documento de
texto}\label{recurso-utilizado-para-a-criauxe7uxe3o-do-documento-de-texto}
