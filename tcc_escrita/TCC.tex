...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, frame hidden, enhanced, boxrule=0pt, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
trajetória. Em 1940, apenas 31\% da população vivia em áreas urbanas.
Contudo, esse cenário mudou rapidamente, e, em 1970, mais da metade da
população já residia em cidades (WAGNER; WARD, 1980). Esse processo de
urbanização acelerado e desordenado resultou em um crescimento
desorganizado das grandes metrópoles, agravando problemas urbanos, como
o déficit habitacional. Com o aumento das regiões urbanizadas, a demanda
por habitação tornou-se cada vez maior, exigindo medidas para mitigar o
déficit habitacional. Nesse contexto, foi instituída a Lei nº 4.380, de
21 de agosto de 1964, que criou pela primeira vez no país um mecanismo
de crédito habitacional. Essa legislação foi crucial para articular a
oferta e a demanda de recursos destinados ao setor habitacional e
resultou na criação do Sistema Financeiro de Habitação (SFH), que
introduziu inovações como a correção monetária, o Banco Nacional da
Habitação (BNH) e as Sociedades de Crédito Imobiliário (SCI). Embora o
SFH tenha obtido muitos sucessos, o aumento da inflação na década de
1980 impactou seu funcionamento, agravado por medidas adotadas pelos
governos para combater a inflação. Assim, com a experiência acumulada
pelo SFH, foi criado o Sistema de Financiamento Imobiliário (SFI), que
não substituiu o SFH, mas marcou o início de um modelo moderno de
...
imóveis, foi utilizado o gráfico de ICE (Individual Conditional
Expectation) em conjunto com a linha de PDP (Partial Dependence Plot).
