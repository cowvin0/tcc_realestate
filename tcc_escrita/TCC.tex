...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, enhanced, colback={codebgcolor}, breakable, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
