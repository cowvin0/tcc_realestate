...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, enhanced, sharp corners, colback={codebgcolor}, frame hidden, breakable]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
L2 (Ridge) como padrão, mas também permitem o uso da regularização L1
(Lasso).
