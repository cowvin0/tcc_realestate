...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, enhanced, boxrule=0pt, colback={codebgcolor}, breakable, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
