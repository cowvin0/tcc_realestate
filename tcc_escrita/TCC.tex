...
\href{https://scikit-learn.org/stable/}{scikit-learn}, também foram
utilizadas neste trabalho. Entre elas, destacam-se a
\href{https://lightgbm.readthedocs.io/en/stable/}{LightGBM} (KE \emph{et
al.}, 2017) e a
\href{https://xgboost.readthedocs.io/en/stable/}{XGBoost} (CHEN, T.;
GUESTRIN, 2016) (CHEN, T.; GUESTRIN, 2016), empregadas para a
implementação de algoritmos de aprendizado de máquina. Essas bibliotecas
fornecem, respectivamente, os algoritmos de gradient boosting LightGBM e
Extreme Gradient Boosting, reconhecidos por sua eficiência computacional
e desempenho em tarefas de modelagem preditiva.
...
No contexto deste trabalho, o \href{https://quarto.org/}{Quarto} foi
utilizado para a produção de todo o texto, garantindo conformidade com
as normas da ABNT. Sua capacidade de integrar texto, código e gráficos
de maneira organizada foi essencial para facilitar o desenvolvimento do
documento.
...
\includegraphics{includes/map_valor_m2.png}
...
KE, G. \emph{et al.} Lightgbm: A highly efficient gradient boosting
decision tree. \textbf{Advances in neural information processing
systems}, 2017. v. 30.
