...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, breakable, sharp corners, enhanced, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
biblioteca empregada para esse fim. É importante ressaltar que os
códigos desenvolvidos para a raspagem de dados podem deixar de funcionar
...
pacotes de \textbf{R}, tanto os ordenados por data de publicação quanto
os organizados por nome, disponíveis em:
\url{https://cran.r-project.org/web/packages/index.html}. A partir
desses dados, serão gerados dois arquivos \texttt{.csv} contendo essas
informações.
...
\pandocbounded{\includegraphics[keepaspectratio]{includes/page_contents.png}}

}

\caption{\label{fig-page_contents}O HTML conterá todo conteúdo contido
nessa página.}
...
\pandocbounded{\includegraphics[keepaspectratio]{includes/page_content_devtools.png}}

}

\caption{\label{fig-page_contents_devtools}Exemplo do uso das
ferramentas de desenvolvedor do Firefox para inspencionar conteúdo da
página.}
...
HTML poderá ser extraído. Se o \texttt{fetch} deu certo, a saída do
\texttt{response.status} no shell deverá ser 200. Para visualizar o
conteúdo do HTML, basta executar \texttt{response.body}, como pode ser
visto a seguir, mostrando apenas uma parte de seu conteúdo:
