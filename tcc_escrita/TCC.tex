...
um exemplo na \textbf{?@fig-arvore}.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{\%\%| label: fig{-}arvore}
\NormalTok{\%\%| fig{-}cap: Exemplo de estrutura de árvore de regressão. A árvore tem cinco folhas e quatro nós internos.}
\NormalTok{\%\%| fig{-}width: 5.5}

\NormalTok{graph TD}
\NormalTok{    A[Condição 1] {-}{-}\textgreater{}|Condição 1: Sim| B[Condição 2]}
\NormalTok{    A {-}{-}\textgreater{}|Condição 1: Não| C[Condição 3]}
\NormalTok{    B {-}{-}\textgreater{}|Condição 2: Sim| D[Folha 1]}
\NormalTok{    B {-}{-}\textgreater{}|Condição 2: Não| E[Folha 2]}
\NormalTok{    C {-}{-}\textgreater{}|Condição 3: Sim| F[Folha 3]}
\NormalTok{    C {-}{-}\textgreater{}|Condição 3: Não| G[Condição 4]}
\NormalTok{    G {-}{-}\textgreater{}|Condição 4: Sim| H[Folha 4]}
\NormalTok{    G {-}{-}\textgreater{}|Condição 4: Não| I[Folha 5]}
\end{Highlighting}
\end{Shaded}
