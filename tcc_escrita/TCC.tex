...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, colback={codebgcolor}, sharp corners, boxrule=0pt, frame hidden, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
imóveis em João Pessoa, área de estudo.}
...
Tambaú, com um valor médio de R\$ 8.951,45 por
\(m^2. Em terceiro, encontra-se o bairro Jardim Oceania, com um valor médio de R\)
7.879,60 por
\(m^2, seguido pelo bairro Altiplano Cabo Branco, com um valor médio de R\)
7.218,70 por \$m\^{}2.
