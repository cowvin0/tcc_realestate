...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, sharp corners, frame hidden, colback={codebgcolor}, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
