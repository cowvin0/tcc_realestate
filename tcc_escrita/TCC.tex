...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[colback={codebgcolor}, boxrule=0pt, enhanced, frame hidden, breakable, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
