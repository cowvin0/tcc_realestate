...
\section{Tecnologias utilizadas para a coleta de
dados}\label{tecnologias-utilizadas-para-a-coleta-de-dados}
...
apresentados serão aqueles utilizados especificamente para a modelagem.

\section{Recursos utilizados para
modelagem}\label{recursos-utilizados-para-modelagem}
