...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, enhanced, sharp corners, breakable, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
