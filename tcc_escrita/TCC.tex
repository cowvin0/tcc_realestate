...
simétrica. Embora, a transformação \(\log(1 + x)\) tenha sido aplicada
para a maior parte das variáveis numéricas, ela não foi aplicada para
uma única variável, a que representa o produto entre as coordenadas
geográficas e o valor de aluguel, nessa foi aplicada a transformação de
Yeo-Johnson (YEO; JOHNSON, 2000), que contém a vantagem de ser aplicável
para dados que contém valores negativos e 0. A transformação de
