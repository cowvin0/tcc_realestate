...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, colback={codebgcolor}, sharp corners, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
\(k\left(j\right) = \arg \max_{k} \hat{p}_{jk}\), que é a classe
majoritária no nó \(j\).
