...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, sharp corners, frame hidden, colback={codebgcolor}, enhanced, breakable]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
