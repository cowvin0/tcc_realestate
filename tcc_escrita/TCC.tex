...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, frame hidden, colback={codebgcolor}, boxrule=0pt, breakable, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
