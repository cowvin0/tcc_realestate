...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, enhanced, breakable, colback={codebgcolor}, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
Na próxima sessão, apresenta-se um exemplo de como realizar web scraping
...
biblioteca empregada para a extração dos dados. Além disso, esta sessão
...
elementos da página e até mesmo debugar o código.
...
navegadores como Firefox oferecem ferramentas de desenvolvedor que
permitem inspencionar a estrutura da página, como pode ser visto na
...
publicação. Para extrair os \texttt{href}, basta executar em no terminal
o comando
...
Firefox, o exemplo em R será mais direto. Neste exemplo, utiliza-se o
pacote \href{https://rvest.tidyverse.org/}{\textbf{rvest}},
