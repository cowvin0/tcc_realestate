...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, enhanced, boxrule=0pt, sharp corners, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
