...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, frame hidden, sharp corners, colback={codebgcolor}, boxrule=0pt, enhanced]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
