...
as componentes de \(\hat{f}_{U} \left(\boldsymbol{\theta}_{U}\right)\)
...
ou árvores de decisão. Como nem todos os modelos \(g \in G\) podem ser
simples o suficiente para serem interpretados, define-se uma medida de
complexidade \(\Omega\left(g\right)\) para a explicação gerada por
\(g \in G\). Por exemplo, para uma árvore de regressão,
\(\Omega\left(g\right)\) pode ser a profundidade da árvore.
