...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, breakable, frame hidden, colback={codebgcolor}, boxrule=0pt, sharp corners]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
