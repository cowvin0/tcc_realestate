...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, frame hidden, sharp corners, enhanced, breakable, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
