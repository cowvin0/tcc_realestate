...
perceber que a maioria das distribuições possuem assimetria negativa. As
distribuições possuem caudas longas à direita, indicando presença de
valores extremamente altos, indicando a necessidade da aplicação de
alguma transformação para a estabilização da variância.
