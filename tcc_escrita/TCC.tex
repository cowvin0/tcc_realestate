...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, sharp corners, boxrule=0pt, colback={codebgcolor}, frame hidden, breakable]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
