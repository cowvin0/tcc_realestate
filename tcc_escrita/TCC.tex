...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, boxrule=0pt, enhanced, sharp corners, colback={codebgcolor}, breakable]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
que se inicie um projeto usando o seu CLI. Para isso, é utilizado o
comando
\texttt{scrapy\ startproject\ \textless{}nome\_do\_projeto\textgreater{}}.
Esse comando irá criar um diretório com todos os arquivos e
configurações iniciais necessárias para se iniciar a extração de dados
com o \href{https://docs.scrapy.org/en/latest}{\textbf{Scrapy}}. Por
exemplo, suponha que o comando
\texttt{scrapy\ startproject\ scraping\_examples} tenha sido executado.
Após a sua execução, será criado o diretório com a seguinte estrutura:
...
\NormalTok{.}
\NormalTok{|{-}{-} scraping\_examples}
\NormalTok{|   |{-}{-} \_\_init\_\_.py}
\NormalTok{|   |{-}{-} items.py}
\NormalTok{|   |{-}{-} middlewares.py}
\NormalTok{|   |{-}{-} pipelines.py}
\NormalTok{|   |{-}{-} \_\_pycache\_\_}
\NormalTok{|   |   |{-}{-} \_\_init\_\_.cpython{-}310.pyc}
\NormalTok{|   |   |{-}{-} settings.cpython{-}310.pyc}
\NormalTok{|   |{-}{-} settings.py}
\NormalTok{|   |{-}{-} spiders}
\NormalTok{|       |{-}{-} \_\_init\_\_.py}
\NormalTok{|       |{-}{-} \_\_pycache\_\_}
\NormalTok{|           |{-}{-} \_\_init\_\_.cpython{-}310.pyc}
\NormalTok{|{-}{-} scrapy.cfg}
