...
populares como \href{https://plotly.com/}{Plotly} e
\href{https://pandas.pydata.org/}{pandas} (TEAM, 2020), esta última
utilizada para a manipulação das bases de dados empregadas neste
trabalho, e a capacidade de atualizar componentes de forma dinâmica por
meio de funções suas funções \texttt{callback}.
