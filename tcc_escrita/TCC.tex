...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[boxrule=0pt, breakable, colback={codebgcolor}, sharp corners, enhanced, frame hidden]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
