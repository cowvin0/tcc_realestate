...
class ZapSpider(scrapy.Spider):
            ...
            yield Request(
                    ...
                    meta = dict(
                        ...
                        playwright_page_methods = {
                            'evaluate': PageMethod('evaluate', 'Array.from(document.querySelectorAll("a.result-card")).map(a => a.href)')
                            },
    ...
    def parse(self, response):
        hrefs = response.meta['playwright_page_methods']['evaluate'].result
        yield {'href': hrefs}
