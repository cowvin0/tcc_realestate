...
class ZapSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.zapimoveis.com.br/venda/apartamentos/pe+recife/?transacao=venda&onde=,Pernambuco,Recife,,,,,city,BR%3EPernambuco%3ENULL%3ERecife,-8.05774,-34.882963,&tipos=apartamento_residencial&pagina=' + str(page) for page in range(1, 101)]
