        ...
        update_map: function (
            ...
            if (map_type === 'heatmap') {
                ...
                function onMapClick(e) {
                    ...
                    dash_clientside.set_props("input-lat", { value: lat });
                    dash_clientside.set_props("input-lon", { value: lon });
                    dash_clientside.set_props("input-area-alug", { value: aluguel_area !== null ? aluguel_area : "" });
                    dash_clientside.set_props("input-price-alug", { value: aluguel_price !== null ? aluguel_price : "" });
                }
